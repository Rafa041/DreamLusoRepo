...
@Component({
  selector: 'app-real-estate-agent-properties',
  templateUrl: './real-estate-agent-properties.component.html',
  styleUrl: './real-estate-agent-properties.component.scss'
})
export class RealEstateAgentPropertiesComponent implements OnInit {
