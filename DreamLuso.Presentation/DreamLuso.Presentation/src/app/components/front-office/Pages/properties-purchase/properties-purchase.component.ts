...
@Component({
  selector: 'app-properties-purchase',
  templateUrl: './properties-purchase.component.html',
  styleUrl: './properties-purchase.component.scss'
})
export class PropertiesPurchaseComponent implements OnInit {
  properties: Property[] = [];
  ...
  ngOnInit(): void {
    this.loadRentalProperties();  // Now matches the method name
  }
  ...
  loadRentalProperties(): void {
    ...
    this.propertyService.retrieveAll().subscribe({
      next: (properties: Property[]) => {
        ...
        // Update filter to look for rental properties
